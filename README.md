...
<b>ВАЖНО</b> —  На странице https://lk.payin-payout.net/app/#/report/get_operations_payin используя фильтр "Статус уведомления" можно посмотреть по каким платежам система успешно ответила, а по каким ответ был ошибочным. Так же можно отфильтровать платежи по которым система ещё не ответила.
